...
## Supported macOS versions[Permalink](http://jekyllrb.com/docs/installation/macos/#supported-macos-versions)
...
## Install Ruby[Permalink](http://jekyllrb.com/docs/installation/macos/#install-ruby)
...
### Step 1: Install Homebrew[Permalink](http://jekyllrb.com/docs/installation/macos/#step-1-install-homebrew)
...
### Step 2: Install chruby and the latest Ruby with ruby-install[Permalink](http://jekyllrb.com/docs/installation/macos/#step-2-install-chruby-and-the-latest-ruby-with-ruby-install)
...
## Install Jekyll[Permalink](http://jekyllrb.com/docs/installation/macos/#install-jekyll)
...
## Troubleshooting[Permalink](http://jekyllrb.com/docs/installation/macos/#troubleshooting)

See [Troubleshooting](http://jekyllrb.com/docs/troubleshooting/) or [ask for help on our forum](https://talk.jekyllrb.com/).
